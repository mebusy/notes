...
[Amazon EKS](dev_notes/EKS.md) | [docker desktop k8s](dev_notes/k8s-docker-desktop.md) | [k8s storage](dev_notes/k8s_storage.md) |  [expose k8s mysql, phpmyadmin](dev_notes/k8s-phpmyadmin.md)
