...
#### C++
 ...
 a | b | c | d
--- | --- | --- | ---
[modern cpp](dev_notes/moderncpp.md) | [cast,smart pointer](dev_notes/cpp_cast_smart.md) | [cpp RAII](dev_notes/cppRAII.md) |  [cpp QA](dev_notes/cpp_notes.md) 
...
[CppCon 2019: The Best Parts of C++](dev_notes/cpp_best_part.md) | [CppCon 2019: RAII and the Rule of Zero](https://nbviewer.jupyter.org/github/mebusy/cppcontalk/blob/main/pdfs/back_to_basics_raii_and_the_rule_of_zero__arthur_odwyer__cppcon_2019.pdf) |
[utils: googletest](dev_notes/googletest.md) |
...
[create, expose mysql in k8s](dev_notes/k8s_mysql-test.md) | [mongoDB in k8s](dev_notes/mongo-in-k8s.md) |  [redis in k8s](dev_notes/redis-in-k8s.md)  | [phpmyadmin](dev_notes/k8s-phpmyadmin.md)
...
[xargs](dev_notes/linux_xargs.md) |  [ssh](dev_notes/ssh.md) | [bash crash course](dev_notes/linux_bash_crash.md)  | [tmux](dev_notes/linux_tmux.md)
